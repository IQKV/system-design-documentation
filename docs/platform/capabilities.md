...
| Plan catalog                  | Admin-managed plans (`planCode`, pricing, `entitlement`, `scope` TENANT/USER, `trialPeriodDays`); tenant read APIs; soft-delete via `active=false`                                                                                       | ✅     |
...
| Entitlement evaluation        | `EntitlementEvaluator` — active subscription + plan `entitlement` for authorization decisions                                                                                                                                            | ✅     |
